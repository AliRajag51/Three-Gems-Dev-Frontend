...
export const Route = createFileRoute("/account")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to your Three Gems account to manage licenses and downloads." },
    ],
  }),
  ...
  return (
    <div className="mx-auto max-w-md px-5 lg:px-8 py-16 lg:py-24">
      <div className="text-center">
        ...
        <p className="mt-1.5 text-sm text-muted-foreground">{mode === "login" ? "Sign in to manage your licenses" : "Start using Three Gems plugins today"}</p>
      </div>
      ...
      <div className="mt-8 card-surface p-7">
        <form className="space-y-4">
          ...
          <div>
            ...
            <input type="email" className="mt-1.5 w-full px-4 py-3 rounded-xl border border-border bg-surface text-sm focus:outline-none focus:border-primary" />
          </div>
          <div>
            <label className="text-sm font-semibold">Password</label>
            <input type="password" className="mt-1.5 w-full px-4 py-3 rounded-xl border border-border bg-surface text-sm focus:outline-none focus:border-primary" />
          </div>
          {mode === "login" && (
          ...
          <button type="button" className="btn-ruby w-full px-5 py-3 rounded-xl text-sm font-semibold">
