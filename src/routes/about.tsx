  ...
  return (
    <div>
      <section className="hero-bg">
        <div className="mx-auto max-w-4xl px-5 lg:px-8 py-16 lg:py-24 text-center">
          ...
          <p className="mt-5 text-lg text-muted-foreground">
            We've spent the last decade building, breaking and rebuilding WooCommerce stores. Three
            Gems is the toolkit we always wished existed — clean, reliable plugins that respect your
            store, your customers, and your time.
          </p>
        </div>
      </section>
        ...
        {[
          {
            icon: Gem,
            t: "Quality first",
            d: "Every plugin is tested, audited, and shipped with the same engineering standards.",
          },
          {
            icon: Heart,
            t: "Customer obsessed",
            d: "We treat support tickets like product feedback — and ship fixes fast.",
          },
          {
            icon: Zap,
            t: "Performance focused",
            d: "Lean code, smart caching, no bloat. Your store stays fast.",
          },
        ].map((v) => (
      ...
      <section className="mx-auto max-w-7xl px-5 lg:px-8 pb-16">
        <div
          className="rounded-3xl p-10 lg:p-14 text-white"
        ...
        >
          ...
          <p className="mt-3 text-white/85 max-w-2xl">
            From boutique brands to large agencies, store owners rely on Three Gems plugins to power
            their daily operations.
          </p>
          <Link
            to="/plugins"
            className="bg-white text-primary-deep mt-6 inline-block px-5 py-3 rounded-xl text-sm font-semibold hover:bg-white/90 transition-colors"
          >
            Explore plugins
          </Link>
        </div>
