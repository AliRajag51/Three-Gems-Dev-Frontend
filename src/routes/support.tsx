        ...
        {[
          {
            ...
            text: "Step-by-step guides, API reference, and tutorials.",
            to: "/docs" as const,
            cta: "Open docs",
          },
          {
            icon: LifeBuoy,
            title: "Open a ticket",
            text: "Premium support included with every active license.",
            to: "/contact" as const,
            cta: "Submit ticket",
          },
          {
            icon: MessagesSquare,
            title: "Community",
            text: "Chat with other Three Gems builders and store owners.",
            to: "/contact" as const,
            cta: "Join community",
          },
        ].map((c) => (
          <div key={c.title} className="card-surface p-6">
            ...
            <Link to={c.to} className="mt-4 inline-block text-sm font-semibold text-primary">
              {c.cta} →
            </Link>
          </div>
        ))}
        ...
        <div className="card-surface p-8 lg:p-10 grid lg:grid-cols-2 gap-8">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Make sure you're signed in with the email associated with your license. We'll reply
          ...
          <form className="space-y-4">
            ...
            <button type="button" className="btn-ruby px-5 py-3 rounded-xl text-sm font-semibold">
              Send message
            </button>
          </form>
        </div>
